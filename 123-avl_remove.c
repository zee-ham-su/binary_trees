...
/**
 * remove_node_type - Removes a node from the binary
 * search tree based on its children.
 * @node: Node to remove.
 * Return: 0 if it has no children, otherwise a
 * new value to re-balance the tree.
 */
