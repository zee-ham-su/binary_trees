...
/**
 * binary_tree_height - the height of a binary tree measurement
 * @tree: tree to be used to measure the height of
...
/**
* traverse_level - perform level-order traversal on a binary tree
...
/**
 * binary_tree_levelorder - erform level-order traversal on a binary tree.
